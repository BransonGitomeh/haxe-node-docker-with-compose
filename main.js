...
Main.__name__ = true;
Main.main = function() {
	console.log("Main.hx:3:",Sys.environment().h["PORT"]);
	var PORT = process.env["PORT"] != null ? Std.parseInt(Sys.environment().h["PORT"]) : 8000;
	var server = js_node_Http.createServer(function(request,response) {
		response.writeHead(200,{ "Content-Type" : "text/plain"});
		response.end("Hello World\n");
	});
	server.listen(PORT);
	console.log("Main.hx:17:","Server running at 127.0.0.1:" + PORT);
};
Math.__name__ = true;
